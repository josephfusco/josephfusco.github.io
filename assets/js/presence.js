...
(function () {
  ...
  var REGIONS = {
    ...
    eu: [
      ...
      { name: 'House Sparrow',      share: 0.2,  puff: [0.62, 0.8],  neck: [0.0, 0.06],  tail: [0.8, 0.92],  beak: [0.78, 0.88], size: [0.66, 0.73], weight: 0.09, moves: ['turn', 'headBob', 'bob', 'resettle'] },
      ...
      { name: 'Common Starling',    share: 0.16, puff: [0.28, 0.4],  neck: [0.22, 0.32], tail: [0.6, 0.68],  beak: [1.1, 1.2],   size: [0.76, 0.83], weight: 0.25,  moves: ['turn', 'bob', 'headBob'] },
      { name: 'Barn Swallow',       share: 0.12, puff: [0.3, 0.4],   neck: [0.0, 0.06],  tail: [1.25, 1.3],  beak: [0.6, 0.7],   size: [0.69, 0.76], weight: 0.06, forked: true, moves: ['resettle', 'turn'] },
      { name: 'White Wagtail',      share: 0.08, puff: [0.28, 0.38], neck: [0.15, 0.25], tail: [1.2, 1.3],   beak: [0.7, 0.8],   size: [0.69, 0.76], weight: 0.07, moves: ['tailPump', 'turn', 'tailPump'] },
    ],
    as: [
      { name: 'Eurasian Tree Sparrow', share: 0.24, puff: [0.62, 0.8],  neck: [0.0, 0.06],  tail: [0.8, 0.92],  beak: [0.78, 0.86], size: [0.61, 0.68], weight: 0.07, moves: ['turn', 'headBob', 'bob', 'resettle'] },
      ...
      { name: 'Spotted Dove',          share: 0.18, puff: [0.45, 0.58], neck: [0.08, 0.16], tail: [1.1, 1.25],  beak: [0.75, 0.85], size: [0.91, 0.98], weight: 0.53, moves: ['resettle'] },
      { name: 'Common Myna',           share: 0.16, puff: [0.4, 0.52],  neck: [0.25, 0.35], tail: [0.75, 0.85], beak: [1.0, 1.1],   size: [0.82, 0.89], weight: 0.37,  moves: ['turn', 'bob', 'headBob'] },
      { name: 'Black Drongo',          share: 0.14, puff: [0.28, 0.38], neck: [0.2, 0.3],   tail: [1.25, 1.3],  beak: [0.85, 0.95], size: [0.88, 0.95], weight: 0.15, forked: true, moves: ['tailPump', 'turn', 'resettle'] },
      { name: 'Barn Swallow',          share: 0.08, puff: [0.3, 0.4],   neck: [0.0, 0.06],  tail: [1.25, 1.3],  beak: [0.6, 0.7],   size: [0.69, 0.76], weight: 0.06, forked: true, moves: ['resettle', 'turn'] },
    ],
    af: [
      ...
      { name: 'Speckled Pigeon',     share: 0.18, puff: [0.68, 0.88], neck: [0.02, 0.08], tail: [0.78, 0.9],  beak: [0.85, 0.95], size: [0.96, 1.04], weight: 1.17, moves: ['resettle', 'bob'] },
      ...
      { name: 'Red-winged Starling', share: 0.14, puff: [0.32, 0.44], neck: [0.2, 0.3],   tail: [0.95, 1.1],  beak: [1.0, 1.1],   size: [0.89, 0.96], weight: 0.43, moves: ['turn', 'bob', 'headBob'] },
      ...
      { name: 'Common Fiscal',       share: 0.14, puff: [0.35, 0.45], neck: [0.3, 0.4],   tail: [1.0, 1.15],  beak: [1.0, 1.1],   size: [0.78, 0.85], weight: 0.12, moves: ['turn', 'resettle', 'turn'] },
    ],
    oc: [
      { name: 'Crested Pigeon', share: 0.22, puff: [0.6, 0.8],   neck: [0.05, 0.12], tail: [0.95, 1.1],  beak: [0.75, 0.85], size: [0.94, 1.01], weight: 0.67,  crest: true, moves: ['resettle', 'bob'] },
      { name: 'Willie Wagtail', share: 0.2,  puff: [0.3, 0.4],   neck: [0.15, 0.25], tail: [1.25, 1.3],  beak: [0.8, 0.9],   size: [0.74, 0.81], weight: 0.07, moves: ['tailPump', 'turn', 'tailPump'] },
      { name: 'Magpie-lark',    share: 0.16, puff: [0.35, 0.45], neck: [0.25, 0.35], tail: [1.0, 1.15],  beak: [0.95, 1.05], size: [0.87, 0.94], weight: 0.3, moves: ['turn', 'bob', 'headBob'] },
      { name: 'Spotted Dove',   share: 0.16, puff: [0.45, 0.58], neck: [0.08, 0.16], tail: [1.1, 1.25],  beak: [0.75, 0.85], size: [0.91, 0.98], weight: 0.53, moves: ['resettle'] },
      { name: 'Noisy Miner',    share: 0.14, puff: [0.4, 0.5],   neck: [0.2, 0.3],   tail: [1.0, 1.1],   beak: [0.95, 1.05], size: [0.85, 0.92], weight: 0.2, moves: ['turn', 'bob', 'headBob'] },
    ...
    sa: [
      { name: 'Eared Dove',                share: 0.22, puff: [0.45, 0.58], neck: [0.08, 0.16], tail: [1.0, 1.15],  beak: [0.72, 0.82], size: [0.85, 0.92], weight: 0.37,  moves: ['resettle'] },
      ...
      { name: 'Rufous-collared Sparrow',   share: 0.18, puff: [0.55, 0.72], neck: [0.05, 0.12], tail: [0.9, 1.0],   beak: [0.75, 0.85], size: [0.62, 0.69], weight: 0.07, moves: ['turn', 'headBob', 'bob', 'resettle'] },
      { name: 'Great Kiskadee',            share: 0.16, puff: [0.45, 0.55], neck: [0.28, 0.38], tail: [0.9, 1.0],   beak: [1.05, 1.15], size: [0.81, 0.88], weight: 0.2, moves: ['turn', 'resettle', 'turn'] },
      { name: 'Tropical Kingbird',         share: 0.14, puff: [0.32, 0.44], neck: [0.3, 0.4],   tail: [0.95, 1.05], beak: [0.95, 1.05], size: [0.75, 0.82], weight: 0.13, moves: ['turn', 'resettle', 'turn'] },
